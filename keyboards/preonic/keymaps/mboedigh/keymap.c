...
[_MAIN] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, KC_LGUI, KC_MENU, KC_LALT, KC_LSFT,  NAV,    KC_SPC,  FN,      KC_RALT, KC_ENT,  KC_BSLS, KC_RCTL
),
...
[_FN] = LAYOUT_preonic_grid(
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, GAME,    _______, ER,      SYS
),
...
[_GAME] = LAYOUT_preonic_grid(
  ...
  KC_LCTL,   KC_NO,   KC_NO, KC_LALT, KC_LSFT, KC_SPC,  KC_RCTL, KC_RALT, FN,      _______, _______,    MAIN
),
